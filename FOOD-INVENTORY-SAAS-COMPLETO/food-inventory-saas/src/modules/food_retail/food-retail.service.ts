...
import { IInventoryService } from "../core/inventory.interface";

@Injectable()
export class FoodRetailInventoryService implements IInventoryService {
  private readonly logger = new Logger(FoodRetailInventoryService.name);
