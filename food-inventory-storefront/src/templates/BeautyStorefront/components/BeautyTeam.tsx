...
export default function BeautyTeam({
  professionals,
  primaryColor,
}: BeautyTeamProps) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      {professionals.map((prof) => (
        ...
        >
          ...
          <div className="relative">
            ...
            {prof.instagram && (
              <a
                ...
                className="absolute bottom-4 right-4 bg-white p-2 rounded-full shadow-lg hover:scale-110 transition"
          ...
          {/* Info */}
          <div className="p-6">
            <h3 className="text-2xl font-bold mb-1">{prof.name}</h3>
            <p
