...
export default function BeautyLocation({ config, primaryColor }: BeautyLocationProps) {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <div>
        <h3 className="text-3xl font-bold mb-6">Encuéntranos</h3>
            ...
            <div>
              ...
              {config.contactInfo.city && (
                <p className="text-gray-600">
                  {config.contactInfo.city}, {config.contactInfo.country}
                </p>
              )}
            </div>
          </div>
              ...
              {config.beautyConfig.businessHours
                ...
                .map((hours) => (
                  <div key={hours.day} className="flex justify-between text-sm">
                    <span className="font-medium">{daysOfWeek[hours.day]}</span>
      ...
      <div>
        <h3 className="text-3xl font-bold mb-6">Métodos de Pago</h3>

        {config.beautyConfig?.paymentMethods
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg mt-6">
            ...
            <div className="flex gap-4">
              {config.contactInfo.socialMedia.instagram && (
                <a
                  href={`https://instagram.com/${config.contactInfo.socialMedia.instagram.replace('@', '')}`}
                  target="_blank"
                  rel="noopener noreferrer"
              ...
              {config.contactInfo.socialMedia.facebook && (
                <a
                  href={`https://facebook.com/${config.contactInfo.socialMedia.facebook}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 rounded-full flex items-center justify-center hover:scale-110 transition"
                  style={{ background: `${primaryColor}20`, color: primaryColor }}
