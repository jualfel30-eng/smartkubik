...
const baseProfiles = {
  'food-service': {
    key: 'food-service',
    label: 'Restaurante / Servicio de comida',
  ...
  'grocery': {
    ...
    attributeSchema: [
      ...
      { key: 'brand', label: 'Marca', type: 'string', scope: 'product' },
    ],
    inventory: {
      supportsLots: true,
      supportsAttributeMatrix: false,
    ...
    placeholders: {
      productName: 'Ej: Harina Pan 1kg',
      brand: 'Ej: Polar',
      sku: 'Ej: HAR-PAN-1KG',
      barcode: 'Ej: 7591234567890',
      category: 'Ej: Abarrotes',
      subcategory: 'Ej: Harinas',
      description: 'Descripción del producto, peso neto y datos del fabricante',
      variantName: 'Ej: Presentación 1kg',
      variantSku: 'Ej: HAR-PAN-1KG',
      search: 'Buscar por nombre, SKU o marca...',
      sellingUnitName: 'Ej: Kilogramos',
      sellingUnitAbbreviation: 'Ej: kg',
      sellingUnitConversion: 'Ej: 1000',
      sellingUnitPrice: 'Ej: 3.50',
      sellingUnitCost: 'Ej: 2.10',
      sellingUnitMinQty: 'Ej: 0.25',
      sellingUnitIncrement: 'Ej: 0.25',
      variantUnit: 'Ej: kg, unidad, pack',
      variantAdditionalName: 'Ej: Pack 12 unidades',
      variantAdditionalSku: 'Ej: HAR-PAN-PACK12',
    },
  },
  'retail-fashion': {
    key: 'retail-fashion',
  ...
  manufacturing: {
    ...
    placeholders: {
      productName: 'Ej: Crema Facial Hidratante 50ml',
      brand: 'Ej: NaturaBella',
      sku: 'Ej: COSM-CRE-050',
      barcode: 'Ej: 7501234567890',
      category: 'Ej: Cosméticos',
      subcategory: 'Ej: Cuidado Facial',
      description: 'Describe el producto, ingredientes activos y uso',
      variantName: 'Ej: Presentación 50ml',
      variantSku: 'Ej: COSM-CRE-050-50ML',
      search: 'Buscar por producto, SKU o lote...',
      sellingUnitName: 'Ej: Unidad',
      sellingUnitAbbreviation: 'Ej: u',
      sellingUnitConversion: 'Ej: 1',
      sellingUnitPrice: 'Ej: 35.00',
      sellingUnitCost: 'Ej: 15.00',
      sellingUnitMinQty: 'Ej: 1',
      sellingUnitIncrement: 'Ej: 1',
      variantUnit: 'Ej: unidad, kg',
      variantAdditionalName: 'Ej: Presentación 100ml',
      variantAdditionalSku: 'Ej: COSM-CRE-050-100ML',
    },
  },
};
