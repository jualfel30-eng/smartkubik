...
// Static CSS import (moved from dynamic injection for better performance)
import '@/styles/landing.css';

// Industry Backgrounds (WebP optimized - 88% smaller)
...
const SmartKubikLanding = () => {
    ...
    // Add landing page classes on mount (CSS now loaded statically)
    useEffect(() => {
                    ...
                    <div className="max-w-7xl mx-auto">
                        <div id="nav-card" className="glass-card rounded-full px-6 py-3 flex justify-between items-center">
                            ...
                            <a href="#" className="flex items-center gap-3 hover:opacity-80 transition-opacity cursor-pointer">
                                <img src="/assets/logo-smartkubik.png" alt="SmartKubik Logo" className="h-8 w-auto" loading="lazy" />
                            </a>
