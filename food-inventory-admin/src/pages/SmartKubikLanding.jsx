        ...
        <div style={{
            ...
            <div style={{
                ...
                <span style={{ color: 'white', fontWeight: 600, fontSize: '16px' }}>
                    PROGRAMA FUNDADORES ABIERTO
                </span>
                <span style={{ color: 'rgba(255,255,255,0.95)', fontSize: '15px' }}>
                    Solo 90 cupos | Hasta <strong style={{ fontSize: '18px', color: '#FFF700' }}>55% OFF</strong> de por vida
                </span>
                <a href="/fundadores"
                    style={{
                        background: 'white',
...
const SmartKubikLanding = () => {
    ...
    useEffect(() => {
        ...
        styleSheet.textContent = `
          ...
          /* Section 6 AI background gradient fix - SCOPED */
          #landing-page-root #ia > div:first-child {
            background: linear-gradient(to right, rgba(8, 51, 68, 0.2), #0A0F1C, rgba(88, 28, 135, 0.5)) !important;
          }

          /* Button styles from backup - SCOPED */
          ...
          /* Glass card styles from backup - SCOPED - but NOT for stack-card elements */
          ...
          #landing-page-root .animate-float { animation: float 8s ease-in-out infinite; }
          #landing-page-root .animate-bounce-custom { animation: bounce 3s ease-in-out infinite; }
          #landing-page-root .perspective-container { perspective: 1000px; }
          #landing-page-root .glass { background: rgba(255, 255, 255, 0.03); backdrop-filter: blur(12px); }
          #landing-page-root .stack-card { will-change: transform, opacity; transition: transform 0.1s linear, opacity 0.1s linear; }
          #landing-page-root .rotate-y-12 { transform: rotateY(12deg) rotateX(6deg); }
          #landing-page-root .hover-rotate-0:hover { transform: rotateY(0deg) rotateX(0deg) !important; }
          @keyframes pulse-slow { 0%, 100% { opacity: 0.8; } 50% { opacity: 1; } }
          #landing-page-root .animate-pulse-slow { animation: pulse-slow 4s ease-in-out infinite; }
          #landing-page-root .text-transparent bg-clip-text bg-gradient-to-br from-cyan-500 to-emerald-500 { background: linear-gradient(to right, #06B6D4, #A855F7); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; }
          ...
          #landing-page-root .animate-pulse-glow { animation: pulse-glow 3s ease-in-out infinite; }
          ...
          @media (min-width: 640px) and (max-width: 767px) {
            ...
            #landing-page-root #modulos { margin-top: calc(-55vh + 25px) !important; }
          }
          @media (min-width: 768px) and (max-width: 1023px) {
            /* Tablets: -250px overlap */
            #landing-page-root #modulos { margin-top: -53vh !important; }
          }

          /* PROGRESSIVE PADDING SYSTEM (1024px - 1799px) - SCOPED */
          ...
          @media (min-width: 1024px) {
            #landing-page-root #pricing .max-w-7xl {
          ...
          @media (min-width: 1024px) and (max-width: 1279px) {
            ...
            #landing-page-root #modulos { margin-top: -40vh !important; }
            #landing-page-root .max-w-7xl, #landing-page-root .max-w-6xl, #landing-page-root .max-w-5xl, #landing-page-root .max-w-4xl {
            ...
            #landing-page-root h1 { font-size: 2.75rem !important; line-height: 1.1 !important; } /* 44px - RESTORED PRESENCE */
            #landing-page-root h2 { font-size: 1.5rem !important; line-height: 1.2 !important; } /* 24px - Compact */
            #landing-page-root h3 { font-size: 1.25rem !important; line-height: 1.3 !important; } /* 20px - Compact */
            /* Force 14px Body Text for High Density */
            #landing-page-root p, #landing-page-root li, #landing-page-root .text-base, #landing-page-root .text-lg, #landing-page-root span.text-base, #landing-page-root div.text-base {
                font-size: 14px !important;
                line-height: 1.5 !important;
            }
            /* GLOBAL CARD TEXT EXCEPTION (13px) */
            #landing-page-root #parallax-cards p, #landing-page-root .glass-card p, #landing-page-root .glass-card .text-sm, #landing-page-root .stack-card p { font-size: 13px !important; }
          }

          @media (min-width: 1280px) and (max-width: 1439px) {
            /* 1280px - 1439px (13" Pro / Standard Laptop)
               RELAXED PADDING: 4.5rem (was 6rem) */
            #landing-page-root #modulos { margin-top: -38vh !important; }
            #landing-page-root .max-w-7xl, #landing-page-root .max-w-6xl, #landing-page-root .max-w-5xl, #landing-page-root .max-w-4xl {
              /* Padding handled globally below */
            }
            #landing-page-root .max-w-7xl { max-width: 72rem !important; } /* Wide enough */

            /* TUNED TYPOGRAPHY */
            #landing-page-root h1 { font-size: 3rem !important; line-height: 1.2 !important; } /* 48px - IMPACTFUL */
            #landing-page-root h2 { font-size: 1.5rem !important; line-height: 1.3 !important; } /* 24px - Compact */
            /* Force 14px Body Text for High Density */
            #landing-page-root p, #landing-page-root li, #landing-page-root .text-base, #landing-page-root .text-lg, #landing-page-root span.text-base, #landing-page-root div.text-base {
                font-size: 14px !important;
                line-height: 1.5 !important;
            ...
            /* GLOBAL CARD TEXT EXCEPTION (13px) */
            #landing-page-root #parallax-cards p, #landing-page-root .glass-card p, #landing-page-root .glass-card .text-sm { font-size: 13px !important; }
          }
          ...
          @media (min-width: 1440px) and (max-width: 1535px) {
            ...
            #landing-page-root #modulos { margin-top: -45vh !important; }
            #landing-page-root .max-w-7xl, #landing-page-root .max-w-6xl, #landing-page-root .max-w-5xl, #landing-page-root .max-w-4xl {
              /* Padding handled globally below */
            }
            #landing-page-root .max-w-7xl { max-width: 76rem !important; }

            /* TUNED TYPOGRAPHY */
            #landing-page-root h1 { font-size: 3rem !important; line-height: 1.2 !important; } /* 48px */
            #landing-page-root h2 { font-size: 1.5rem !important; line-height: 1.3 !important; } /* 24px */
            /* Force 14px Body Text for High Density */
            #landing-page-root p, #landing-page-root li, #landing-page-root .text-base, #landing-page-root .text-lg, #landing-page-root span.text-base, #landing-page-root div.text-base {
                font-size: 14px !important;
                line-height: 1.5 !important;
          ...
          @media (min-width: 1024px) {
            ...
            #landing-page-root p, #landing-page-root li, #landing-page-root .text-base, #landing-page-root .text-lg, #landing-page-root span.text-base, #landing-page-root div.text-base, #landing-page-root .text-sm {
            ...
            #landing-page-root nav .text-sm, #landing-page-root #nav-card .text-sm {
                font-size: clamp(12px, 1vw, 16px) !important;
            }

            /* 5.1 HERO BADGE EXCEPTION */
            /* Adaptive: 12px min -> 14px max (Compact on 2xl) */
            #landing-page-root #hero-badge-text {
            ...
            #landing-page-root #section2-subtitle,
            #landing-page-root #section4-subtitle,
            #landing-page-root #section55-subtitle,
            #landing-page-root #section-ai-subtitle,
            #landing-page-root #section-web-subtitle,
            #landing-page-root #section7-subtitle,
            #landing-page-root #section10-subtitle,
            #landing-page-root #section13-subtitle,
            #landing-page-root #section14-subtitle,
            #landing-page-root .stack-card p {
            ...
            /* 4. PRICING CARDS */
            #landing-page-root #pricing .max-w-7xl, #landing-page-root #pricing .max-w-6xl {
          ...
          @media (min-width: 1168px) and (max-width: 1312px) {
             #landing-page-root #modulos { margin-top: -37vh !important; }
          }

          @media (min-width: 2000px) {
            /* 2056x1285+: Keep current value */
            #landing-page-root #modulos { margin-top: calc(-53vh + 10px) !important; }
          }
        `;
                    ...
                    <div className="grid md:grid-cols-3 gap-8 items-center max-w-[90%] mx-auto">
                        ...
                        <div className="glass-card p-8 rounded-3xl border border-white/10 hover:border-white/20 transition-all">
                            ...
                            <ul className="space-y-4 text-sm text-gray-300">
                                ...
                                <li className="flex gap-3"><span className="text-emerald-400">✓</span> <span className={`lang-es ${language === "es" ? "" : "hidden"} `}>WhatsApp Nativo (Manual)</span><span className={`lang-en ${language === "en" ? "" : "hidden"} `}>Native WhatsApp (Manual)</span></li>
                                <li className="flex gap-3"><span className="text-emerald-400">✓</span> <span className={`lang-es ${language === "es" ? "" : "hidden"} `}>Web de ventas vinculada</span><span className={`lang-en ${language === "en" ? "" : "hidden"} `}>Linked sales website</span></li>
                                <li className="flex gap-3"><span className="text-red-400">✕</span> <span className={`lang-es ${language === "es" ? "" : "hidden"} `}>Sin automatización IA</span><span className={`lang-en ${language === "en" ? "" : "hidden"} `}>No AI automation</span></li>
                                <li className="flex gap-3"><span className="text-red-400">✕</span> <span className={`lang-es ${language === "es" ? "" : "hidden"} `}>Sin agentes de análisis</span><span className={`lang-en ${language === "en" ? "" : "hidden"} `}>No analysis agents</span></li>
                                <li className="flex gap-3"><span className="text-red-400">✕</span> <span className={`lang-es ${language === "es" ? "" : "hidden"} `}>Sin integraciones (Gmail/Outlook)</span><span className={`lang-en ${language === "en" ? "" : "hidden"} `}>No integrations (Gmail/Outlook)</span></li>
                            </ul>
                        </div>
                        ...
                        <div
                            ...
                            <ul className="space-y-4 text-sm text-gray-300">
                                ...
                                <li className="flex gap-3"><span className="text-emerald-400">✓</span> <span className={`lang-es ${language === "es" ? "" : "hidden"} `}>Hasta 2 sucursales</span><span className={`lang-en ${language === "en" ? "" : "hidden"} `}>Up to 2 branches</span></li>
                                <li className="flex gap-3"><span className="text-emerald-400">✓</span> <span className={`lang-es ${language === "es" ? "" : "hidden"} `}>WhatsApp IA (Auto-respuestas)</span><span className={`lang-en ${language === "en" ? "" : "hidden"} `}>AI WhatsApp (Auto-replies)</span></li>
                                <li className="flex gap-3"><span className="text-emerald-400">✓</span> <span className={`lang-es ${language === "es" ? "" : "hidden"} `}>Agente IA de Análisis</span><span className={`lang-en ${language === "en" ? "" : "hidden"} `}>AI Analysis Agent</span></li>
                                <li className="flex gap-3"><span className="text-emerald-400">✓</span> <span className={`lang-es ${language === "es" ? "" : "hidden"} `}>Integraciones Full (Gmail/Outlook)</span><span className={`lang-en ${language === "en" ? "" : "hidden"} `}>Full Integrations (Gmail/Outlook)</span></li>
                        ...
                        <div className="glass-card p-8 rounded-3xl border border-white/10 hover:border-white/20 transition-all">
                            ...
                            <ul className="space-y-4 text-sm text-gray-300">
                                <li className="flex gap-3"><span className="text-emerald-400">✓</span> <span className={`lang-es ${language === "es" ? "" : "hidden"} `}>Usuarios Ilimitados</span><span className={`lang-en ${language === "en" ? "" : "hidden"} `}>Unlimited Users</span></li>
                                ...
                                <li className="flex gap-3"><span className="text-emerald-400">✓</span> <span className={`lang-es ${language === "es" ? "" : "hidden"} `}>Soporte VIP (&lt; 2h)</span><span className={`lang-en ${language === "en" ? "" : "hidden"} `}>VIP Support (&lt; 2h)</span></li>
                                <li className="flex gap-3"><span className="text-emerald-400">✓</span> <span className={`lang-es ${language === "es" ? "" : "hidden"} `}>Onboarding Concierge</span><span className={`lang-en ${language === "en" ? "" : "hidden"} `}>Concierge Onboarding</span></li>
                                <li className="flex gap-3"><span className="text-emerald-400">✓</span> <span className={`lang-es ${language === "es" ? "" : "hidden"} `}>Auditoría IA Mensual</span><span className={`lang-en ${language === "en" ? "" : "hidden"} `}>Monthly AI Audit</span></li>
                                <li className="flex gap-3"><span className="text-emerald-400">✓</span> <span className={`lang-es ${language === "es" ? "" : "hidden"} `}>Acceso Beta Tester</span><span className={`lang-en ${language === "en" ? "" : "hidden"} `}>Beta Tester Access</span></li>
                                <li className="flex gap-3"><span className="text-emerald-400">✓</span> <span className={`lang-es ${language === "es" ? "" : "hidden"} `}>Todo lo del plan Professional</span><span className={`lang-en ${language === "en" ? "" : "hidden"} `}>Everything in Professional</span></li>
                            </ul>
                        </div>
                    </div>
