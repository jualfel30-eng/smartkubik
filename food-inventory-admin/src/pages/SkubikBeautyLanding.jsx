...
/* Back */
.s-pain-back { background: linear-gradient(160deg, #1d1f12, var(--s-bg2) 55%); border-color: rgba(208,255,58,0.3); transform: rotateY(180deg); justify-content: flex-start; }
...
@media (max-width: 900px) {
  ...
  .s-iphone { width: 77vw !important; height: auto !important; aspect-ratio: 9/19.5 !important; max-height: calc(100% - 16px) !important; border-radius: 42px !important; margin: 0 0 16px !important; }
...
.s-iphone { position: relative; width: 302px; height: 660px; border-radius: 52px; background: #1c1c1e; border: 3px solid #38383a; box-shadow: 0 24px 80px rgba(0,0,0,0.7), 0 0 0 1px rgba(255,255,255,0.06); overflow: hidden; }
/* Dynamic Island */
