...
const VariantComparison = ({ campaignId, onWinnerSelected }) => {
  ...
  const metricConfig = {
    ...
    conversion_rate: { label: 'Tasa de Conversi�n', icon: ShoppingCart, format: (v) => `${v.toFixed(2)}%` },
          ...
          <div className="flex items-center justify-between">
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="font-semibold">M�trica de Optimizaci�n</h3>
              </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-xs text-gray-500">
                      {variant.trafficPercentage}% de tr�fico
                    </p>
                  </div>
                </div>
              </CardHeader>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="text-gray-500">
                      {((metricValue / getMetricValue(leader)) * 100).toFixed(0)}% del l�der
                    </span>
                  </div>
                  <Progress
