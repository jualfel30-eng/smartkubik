...
const MATCH_STYLES = {
  barcode_exact: 'bg-info/10 text-blue-800 border-blue-200 dark:bg-blue-900/30 dark:text-blue-400 dark:border-blue-800',
  ...
  name_brand_size: 'bg-success/10 text-green-800 border-green-200 dark:bg-green-900/30 dark:text-green-400 dark:border-green-800',
