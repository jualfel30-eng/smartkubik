...
export function ProductPriceListManager({
  ...
  const getPriceListTypeColor = (type) => {
    const colors = {
      standard: 'bg-info/10 text-blue-800 dark:bg-blue-900 dark:text-blue-200',
      wholesale: 'bg-purple-100 text-purple-800 dark:bg-purple-900 dark:text-purple-200',
      retail: 'bg-success/10 text-green-800 dark:bg-green-900 dark:text-green-200',
      promotional: 'bg-destructive/10 text-red-800 dark:bg-red-900 dark:text-red-200',
      seasonal: 'bg-warning/10 text-orange-800 dark:bg-orange-900 dark:text-orange-200',
