...
export function SEOEditor({ config, onUpdate, saving }: SEOEditorProps) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-medium text-gray-900 mb-4">Optimización SEO</h3>
        ...
        <div className="bg-gray-100 p-6 rounded-lg">
          <h4 className="text-sm font-medium text-gray-700 mb-3">Vista Previa en Google</h4>
          <div className="bg-white p-4 rounded border border-gray-200">
            <div className="text-blue-600 text-xl">{seo.title}</div>
            <div className="text-green-700 text-sm mt-1">
              https://storefront.com/{config.domain}
            </div>
            <div className="text-gray-600 text-sm mt-2">{seo.description}</div>
          </div>
        </div>
      </div>
