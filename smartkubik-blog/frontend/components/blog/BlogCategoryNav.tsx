...
const BlogCategoryNav: React.FC<BlogCategoryNavProps> = ({ onCategoryChange, onSearch }) => {
                ...
                <div className="flex flex-wrap items-center justify-center gap-2 mb-4">
                    {categories.map((category) => (
                        <Button
                            ...
                            className={`${category.color} transition-all duration-200 ${activeCategory === category.id ? 'ring-2 ring-primary' : ''
                                }`}
                        >
                            {category.icon}
