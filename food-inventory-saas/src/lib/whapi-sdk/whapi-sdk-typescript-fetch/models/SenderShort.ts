 ...
 * 
 * @export
 * @interface SenderShort
 */
export interface SenderShort {
    /**
...
/**
 * Check if a given object implements the SenderShort interface.
 */
export function instanceOfSenderShort(value: object): value is SenderShort {
    if (!('to' in value) || value['to'] === undefined) return false;
    if (!('media' in value) || value['media'] === undefined) return false;
    return true;
}

export function SenderShortFromJSON(json: any): SenderShort {
    return SenderShortFromJSONTyped(json, false);
}

export function SenderShortFromJSONTyped(json: any, ignoreDiscriminator: boolean): SenderShort {
    if (json == null) {
        return json;
    }
    return {
...
export function SenderShortToJSON(json: any): SenderShort {
    return SenderShortToJSONTyped(json, false);
}

export function SenderShortToJSONTyped(value?: SenderShort | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
