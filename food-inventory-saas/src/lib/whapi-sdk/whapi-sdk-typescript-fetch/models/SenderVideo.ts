...
/**
 * Check if a given object implements the SenderVideo interface.
 */
export function instanceOfSenderVideo(value: object): value is SenderVideo {
...
export function SenderVideoFromJSON(json: any): SenderVideo {
    return SenderVideoFromJSONTyped(json, false);
}
...
export function SenderVideoToJSON(json: any): SenderVideo {
    return SenderVideoToJSONTyped(json, false);
}

export function SenderVideoToJSONTyped(value?: SenderVideo | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
