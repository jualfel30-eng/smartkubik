...
describe("EduSubjectsService", () => {
  let service: EduSubjectsService;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        EduSubjectsService,
        {
          provide: getModelToken(EduSubject.name),
    ...
    service = module.get<EduSubjectsService>(EduSubjectsService);
  });
  ...
  it("should not return subjects from another tenant", async () => {
