...
export interface IInventoryService {
  create(createInventoryDto: any, user: any, session?: ClientSession): Promise<any>;
  createMovement(movementDto: any, user: any, session?: ClientSession): Promise<any>;
  reserveInventory(reserveDto: any, user: any, session?: ClientSession): Promise<void>;
  releaseInventory(releaseDto: any, user: any, session?: ClientSession): Promise<void>;
  commitInventory(order: any, user: any, session?: ClientSession): Promise<void>;
  adjustInventory(adjustDto: any, user: any, session?: ClientSession): Promise<any>;
  addStockFromPurchase(item: any, user: any, session?: ClientSession): Promise<void>;
