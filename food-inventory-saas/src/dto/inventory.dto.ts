...
export class CreateInventoryDto {
  ...
  @ApiPropertyOptional({ description: "Referencia para agrupar recibos de inventario" })
  @IsOptional()
  @IsString()
  reference?: string;
}
...
export class InventoryMovementDto {
  ...
  @ApiProperty({
    ...
    enum: ["in", "out", "adjustment", "transfer", "reservation", "release"],
  })
...
export class ReserveInventoryDto {
  ...
  @ApiPropertyOptional({
    description: "Minutos hasta expiración de la reserva",
    default: 30,
  })
  @IsOptional()
  @IsNumber()
...
export class ReserveInventoryItemDto {
  ...
  @ApiPropertyOptional({
    description: "Usar FEFO (First Expired First Out)",
    default: true,
  })
  @IsOptional()
  @IsBoolean()
...
export class ReleaseInventoryDto {
  ...
  @ApiPropertyOptional({
    description:
      "SKUs específicos a liberar (si no se especifica, libera toda la orden)",
  })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
...
export class InventoryQueryDto {
  ...
  @ApiPropertyOptional({
    ...
    enum: ["productName", "availableQuantity", "updatedAt", "sku", "cost"],
  })
  @IsOptional()
  @IsEnum(["productName", "availableQuantity", "updatedAt", "sku", "cost"])
